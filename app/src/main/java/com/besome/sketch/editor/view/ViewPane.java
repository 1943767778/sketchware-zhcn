...
import pro.sketchware.util.SafeFirebase;
...
public class ViewPane extends RelativeLayout {
        ...
        try {
            ...
            if (viewBean.id.charAt(0) == '_') {
                ...
                if (viewBean.getClassInfo().b("FloatingActionButton") && (imageBean = viewBean.image) != null && (str = imageBean.resName) != null && !str.isEmpty()) {
                    try {
                        SafeFirebase.log("ViewPane: trying to set image to FAB");
                        ...
                        if (resourcesManager.h(viewBean.image.resName) == ProjectResourceBean.PROJECT_RES_TYPE_RESOURCE) {
                            ...
                            if (imageFile.exists()) {
                                ...
                                if (imagePath.endsWith(".xml")) {
                                    SafeFirebase.log("ViewPane: loading scaled XML/SVG image");
                                ...
                                SafeFirebase.log("ViewPane: converting XML to SVG for FAB");
                        ...
                        SafeFirebase.recordException(exception);
                    }
                }
            ...
            if (classInfo.a("ImageView")) {
                if (resourcesManager.h(viewBean.image.resName) == ProjectResourceBean.PROJECT_RES_TYPE_RESOURCE) {
                    ...
                    try {
                        ...
                        SafeFirebase.recordException(unused2);
            ...
            if (view instanceof EditorListItem listItem) {
                ...
                SafeFirebase.log("ViewPane: setting item count to EditorListItem");
    ...
    private void updateLayout(View view, ViewBean viewBean) {
        SafeFirebase.log("ViewPane: Updating layout");
